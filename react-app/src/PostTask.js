			...
			<div className="PostTask">
				...
				<div class="panel panel-heading">Post a new Task</div>
					<div class="panel panel-body">
						...
						<strong>TaskId:</strong> <br /> <input type="text" name="taskId" value={this.state.taskId} onChange={this.handleChange} /> <br />
						...
						<strong>start:</strong> <br /> <input type="text" name="start" value={this.state.state} onChange={this.handleChange} /> <br /><br />
						<strong>end:</strong> <br /> <input type="text" name="end" value={this.state.end} onChange={this.handleChange} /> <br /><br />
						<button class="btn btn-primary" onClick={() => {this.handleSubmit(); this.props.refresh();}}>Post Task</button>
					</div>
				</div>
			</div>
		);
